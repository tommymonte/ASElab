...
FINALCALC:
    ...
    sub.d f10, f5, f2        # f5 = f5 - f2

    div.d f7, f10, f6        # f7 = f5 / f6, non posso spostarla, dipende d f5

    s.d f10, v4(R1)          # salvo in v4

    sub.d f11, f7, f8        # f7 = f7 - f8
    sub.d f9, f10, f1        # f9 = f5 - f1, sposto la sub

    s.d f11, v5(R1)          # salvo in v5

    mul.d f12, f9, f8        # f9 = f9 * f8
    s.d f12, v6(R1)          # salvo in v6
